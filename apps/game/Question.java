...
public record Question(String text, List<String> options, int correctIndex) {
    ...
    public static final List<Question> ALL = List.of(
            ...
            new Question("プログラムの誤りを見つけて修正する作業を何という？", List.of("コンパイル", "デバッグ", "ダウンロード", "インストール"), 1),
            new Question("Javaでクラスを定義するときに使うキーワードは？", List.of("class", "def", "function", "module"), 0),
            ...
            new Question("Javaで標準出力に文字列を表示する命令は？",
                    List.of("System.out.println", "print.out.System", "Console.write", "String.println"), 0),
            new Question("ネットワーク通信で、相手のアプリケーションを識別するために使う番号は？", List.of("IPアドレス", "ポート番号", "MACアドレス", "ファイル番号"), 1));
}
